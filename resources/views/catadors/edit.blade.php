...
@extends('templates.main', ['titulo' => "Alterar Catador"])
<!-- Preenche o conteúdo da seção "titulo" -->
@section('titulo') Catador @endsection
<!-- Preenche o conteúdo da seção "conteudo" -->
@section('conteudo')

<form action="{{ route('catadors.update', $dados['id']) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('catadors.index')}}" class="btn btn-secondary btn-block align-content-center">
