...
@extends('templates.main', ['titulo' => "Alterar Gerador Residuo"])
<!-- Preenche o conteúdo da seção "titulo" -->
@section('titulo') Gerador Residuo @endsection
<!-- Preenche o conteúdo da seção "conteudo" -->
@section('conteudo')

<form action="{{ route('geradorResiduos.update', $dados['id']) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
            <div class="form-floating mb-3">
                <input 
                    ...
                    value="{{$dados['nome']}}"
                />
                <label for="nome">Nome do Gerador Residuo</label>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col" >
            <div class="form-floating mb-3">
                ...
                />
                <label for="telefone">Teledone</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('geradorResiduos.index')}}" class="btn btn-secondary btn-block align-content-center">
