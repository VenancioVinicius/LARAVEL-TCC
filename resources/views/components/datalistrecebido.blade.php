            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href= "{{ route('recebidos.edit', $item[$header[0]]) }}" class="btn btn-success">
                            ...
                            <a nohref style="cursor:pointer" onclick="showRemoveModal('{{ $item[$header[0]] }}', '{{ $item[$header[0]] }}')" class="btn btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FFF" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                </svg>
                            </a>
                        </td>
                        <form action="{{ route('recebidos.destroy', $item[$header[0]]) }}" method="POST" id="form_{{$item[$header[0]]}}">
                            @csrf
                            @method('DELETE')
                        </form>
                    </tr>
